import { NetService, PacketTypes, type HostGamePacket, type Packet, type PlayerJoinPacket, GameState, type ChangeGameStatePacket, type TickPacket, type QuestionShowPacket, type LeaderboardPacket, type LeaderboardEntry } from "../net";
